...
while repeat < 3 do
  ...
  ratios_hash = RatioFilter.selected_ratios(input_frags, :ratio_adjust => adjust, :only_frag_with_vars => true)
...
if pars['test']
  ...
  dic_ratios_inv  = RatioFilter.selected_ratios(original, :ratio_adjust => adjust, :only_frag_with_vars => false)
