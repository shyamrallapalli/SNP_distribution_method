...
File.open("#{logfold}/snp_data.yml", "w") do |file|
  file.write snp_data.to_yaml
end
File.open("#{logfold}/frag_pos.yml", "w") do |file|
  file.write frag_pos.to_yaml
end
WriteIt::write_txt("#{logfold}/hm_positions", hm)
WriteIt::write_txt("#{logfold}/ht_positions", ht)
...
File.open("#{logfold}/dic_pos_ht.yml", "w") do |file|
